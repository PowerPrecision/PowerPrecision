...
Base URL: https://crm-real-estate.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://crm-real-estate.preview.emergentagent.com').rstrip('/')
