...
Base URL: https://property-crm-review.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://property-crm-review.preview.emergentagent.com').rstrip('/')
