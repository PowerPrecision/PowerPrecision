...
Base URL: https://client-aggregator.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://client-aggregator.preview.emergentagent.com').rstrip('/')
