...
Base URL: https://ai-document-flow.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://ai-document-flow.preview.emergentagent.com').rstrip('/')
