...
Base URL: https://ai-import-logger.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://ai-import-logger.preview.emergentagent.com').rstrip('/')
