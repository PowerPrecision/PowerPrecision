...
Base URL: https://process-mgmt-crm.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://process-mgmt-crm.preview.emergentagent.com').rstrip('/')
