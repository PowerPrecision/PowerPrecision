...
Base URL: https://consultant-hub-40.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://consultant-hub-40.preview.emergentagent.com').rstrip('/')
