...
Base URL: https://idealista-import-dev.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://idealista-import-dev.preview.emergentagent.com').rstrip('/')
