...
Base URL: https://crm-bugfix-20.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://crm-bugfix-20.preview.emergentagent.com').rstrip('/')
