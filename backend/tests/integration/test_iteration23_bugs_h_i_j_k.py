...
Base URL: https://categorize-notify.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://categorize-notify.preview.emergentagent.com').rstrip('/')
