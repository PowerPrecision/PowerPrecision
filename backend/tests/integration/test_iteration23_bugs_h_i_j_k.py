...
Base URL: https://smart-docs-47.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://smart-docs-47.preview.emergentagent.com').rstrip('/')
