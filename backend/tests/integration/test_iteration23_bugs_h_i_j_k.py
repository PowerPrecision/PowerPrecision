...
Base URL: https://dedup-finance-data.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://dedup-finance-data.preview.emergentagent.com').rstrip('/')
