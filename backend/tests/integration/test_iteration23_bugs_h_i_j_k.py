...
Base URL: https://minuta-system.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://minuta-system.preview.emergentagent.com').rstrip('/')
