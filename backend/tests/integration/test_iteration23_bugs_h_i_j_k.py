...
Base URL: https://crm-realstate-v2.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://crm-realstate-v2.preview.emergentagent.com').rstrip('/')
