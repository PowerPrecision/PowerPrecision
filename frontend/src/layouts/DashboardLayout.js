...
const DashboardLayout = ({ children, title }) => {
  ...
  const getInitialOpenSections = () => {
    ...
    const sistemaRoutes = ["/admin/backups", "/definicoes", "/configuracoes", "/configuracoes/notificacoes", "/admin/logs", "/admin/logs-importacao", "/admin/mapeamentos-nif", "/admin/processos-background"];
